...
/**
 * Copy of org.springframework.http.ContentDisposition from Spring Boot release 2.3.12.RELEASE for backward compatibility
 * New version adds into Content-disposition header both filename and filename*
 * and it changes behaviour of a browser
 */
public final class ContentDisposition {
    ...
    private static class BuilderImpl implements ContentDisposition.Builder {
